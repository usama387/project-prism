...
import { CreateIssue } from "../_actions/issue";
...
const CreateIssueDialog = ({ trigger, projects, tasks }: Props) => {
  // managing opening state of dialog
  const [open, setOpen] = useState(false);

  // form validation with zod and react hook form
  const form = useForm<CreateIssueSchemaType>({
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Issue Description (required)</FormDescription>
                </FormItem>
              )}
            />
